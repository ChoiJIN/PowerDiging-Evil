...
bool CObjLoader::loadObjects(const char *fileName)
{
...
bool CObjLoader::loadMaterials(const char *fileName)
{
	FILE *fp = fopen(fileName, "r");
	if (!fp) return false;
...
bool CObjLoader::loadTexture(const char *fileName, unsigned int *texture)
{
